...
If it displays anything that doesn't exactly match the above choices, [contact me](https://fohdeesha.com/) with a screenshot. If you're impatient and pick the "closest one" instead, you'll brick your card.
